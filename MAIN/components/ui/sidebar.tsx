...
function Sidebar({
  ...
  return (
    <div
      className="group peer text-sidebar-foreground hidden md:block transition-all duration-150 ease-out"
      data-state={state}
  ...
  return (
    <main
      ...
      className={cn(
        ...
        "md:ml-(--sidebar-width) md:peer-data-[collapsible=offcanvas]:ml-0 md:peer-data-[collapsible=icon]:ml-(--sidebar-width-icon)",
